...
171801 (2009)~\cite{Wei:2009}). The vetoed $\jpsi\,K^{*}$ sample itself
served as the control channel for efficiencies and PID. The most recent
Belle~II measurement of this same final state
(arXiv:2206.05946~\cite{BelleII:2206}) uses the
...
physics motivation as Wei et al.\ [Belle]~\cite{Wei:2009} and the
Belle~II $K^{*}(892)\ell\ell$ measurement~\cite{BelleII:2206}.
...
arXiv:2206.05946~\cite{BelleII:2206}).}
\label{tab:veto}
\end{table}
...
candidates reported by Belle~II with 189\,fb$^{-1}$
(arXiv:2206.05946~\cite{BelleII:2206}), scaled up by the larger
1\,ab$^{-1}$ sample size.
...
171801 (2009)~\cite{Wei:2009} and the Belle~II
$B\to K^{*}(892)\ell\ell$ branching-fraction measurement
(arXiv:2206.05946~\cite{BelleII:2206}) --- a $K^{*}$ mass
...
\bibitem{BelleII:2206}
Belle~II Collaboration, arXiv:2206.05946.
